NOT WINDOWS COMPATIBLE BECAUSE WINDOWS SUCKS

Put main.py and categories.py anywhere

There are 15 categories in main.py, you need to
remove the # if you want to use that category
and change any of the information
